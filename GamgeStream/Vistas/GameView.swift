...
//  GamgeStream
//
//  Created by Tulio Rangel on 22/12/22.
//
        ...
        ZStack {
            ...
            VStack {
                ...
                ScrollView {
                    ...
                    //Galeria de imagenes en scroll horizontal
...
struct video:View {
    ...
    var body: some View{
        ...
        VideoPlayer(player: AVPlayer(url: URL(string: url)!)).ignoresSafeArea().onDisappear(perform: {
            AVPlayer().pause()
        })
    }
}
